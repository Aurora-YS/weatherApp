$(document).ready(function(){
    ...
    var myKey = "c13947b64116871cbb287cdf4e502e75";
        ...
        $("#weather li").each(function(index){
            $.ajax({
                ...
                success : function(data){
                    ...
                    // console.log(this);  //{url: 'https://api.openweathermap.org/data/2.5/weather?q=Seoul&appid=c13947b64116871cbb287cdf4e502e75', type: 'GET', isLocal: false, global: true, processData: true, …}
    ...
    */
    ...
    $(document).on("click", ".cities button", function(){
        ...
        city.unshift($city_txt);    //클릭한 버튼의 텍스트를 city라는 배열의 첫번째 자리에 위치를 시킨다.  ==> 마지막에 클릭한 버튼의 데이터 정보는 리스트 중에서 맨 처음에 나온다.
        console.log(city);
